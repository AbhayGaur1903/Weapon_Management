...
#     frappe.msgprint(str(rank))
#     personnels = frappe.db.get_all("Person Master", filters = {"rank": rank},fields = ["name"])
#     personnelList = [name['name'] for name in personnels]
#     frappe.msgprint(str(personnelList))
