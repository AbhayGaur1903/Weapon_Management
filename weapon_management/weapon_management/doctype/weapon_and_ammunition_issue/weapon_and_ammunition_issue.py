...
@frappe.whitelist()
def validate_and_get_ammunition_details(ammunition_rfid, weaponCategory,unitLocation):
    ammunitionCategory = frappe.get_value("Weapon Master", {"weapon_category": weaponCategory}, ['ammunition_category'])
